...
/****************************************************************************/
/// @file    MSCFModel_H3.cpp
/// @author  Tobias Mayer
/// @author  Daniel Krajzewicz
/// @author  Michael Behrisch
/// @date    Thu, 03 Sep 2009
///
// H3 ACC car-following model
/****************************************************************************/
#include <config.h>

#include "MSCFModel_H3.h"
...
// method definitions
// ===========================================================================
MSCFModel_H3::MSCFModel_H3(const MSVehicleType* vtype, bool idmm) :
    MSCFModel(vtype),
    myIDMM(idmm),
...
MSCFModel_H3::~MSCFModel_H3() {}


double
MSCFModel_H3::minNextSpeed(double speed, const MSVehicle* const /*veh*/) const {
...
double
MSCFModel_H3::finalizeSpeed(MSVehicle* const veh, double vPos) const {
...
double
MSCFModel_H3::freeSpeed(const MSVehicle* const veh, double speed, double seen, double maxSpeed, const bool /*onInsertion*/, const CalcReason /*usage*/) const {
    if (maxSpeed < 0.) {
...
double
MSCFModel_H3::followSpeed(const MSVehicle* const veh, double speed, double gap2pred, double predSpeed, double predMaxDecel, const MSVehicle* const pred, const CalcReason /*usage*/) const {
...
double
MSCFModel_H3::insertionFollowSpeed(const MSVehicle* const v, double speed, double gap2pred, double predSpeed, double predMaxDecel, const MSVehicle* const pred) const {
...
double
MSCFModel_H3::insertionStopSpeed(const MSVehicle* const veh, double speed, double gap) const {
...
double
MSCFModel_H3::stopSpeed(const MSVehicle* const veh, const double speed, double gap, double decel, const CalcReason /*usage*/) const {
...
double
MSCFModel_H3::interactionGap(const MSVehicle* const veh, double vL) const {
...
double
MSCFModel_H3::getSecureGap(const MSVehicle* const /*veh*/, const MSVehicle* const /*pred*/, const double speed, const double leaderSpeed, const double /*leaderMaxDecel*/) const {
...
double
MSCFModel_H3::_v(const MSVehicle* const veh, const double gap2pred, const double egoSpeed,
...
MSCFModel*
MSCFModel_H3::duplicate(const MSVehicleType* vtype) const {
    return new MSCFModel_H3(vtype, myIDMM);
}
