 ...
 * @see MSCFModel
 */
class MSCFModel_H3 : public MSCFModel {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_H3(const MSVehicleType* vtype, bool idmm);
     ...
     */
    MSCFModel_H3(const MSVehicleType* vtype, double accel, double decel, double emergencyDecel, double apparentDecel,
...
private:
    ...
    MSCFModel_H3& operator=(const MSCFModel_H3& s);
};
